...
- On November 7, 1940, the Tacoma Narrows Bridge—a suspension bridge spanning the Puget Sound west of Tacoma, Washington—was less than five months old.
- You will practice Define the concepts of period, frequency, amplitude, and phase shift in oscillatory motion; Solve the differential equation for simple harmonic motion and write down the position, velocity, and acceleration as functions of time; Apply the relationship $T = 2\pi\sqrt{m/k}$ to find the period of a mass on a spring, and $T = 2\pi\sqrt{L/g}$ for a simple pendulum.
